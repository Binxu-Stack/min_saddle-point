...
MinimizeStyle(saddle_hftn,MinSaddleHFTN)

#else

#ifndef LMP_MIN_SADDLE_HFTN_H
#define LMP_MIN_SADDLE_HFTN_H
...
class MinSaddleHFTN : public MinSaddle
{
  public:

  MinSaddleHFTN (LAMMPS *);
  ~MinSaddleHFTN (void);
  void init();
  void setup_style();
  void reset_vectors();
  ...
  enum {
    VEC_XK=0,   //-- ATOM POSITIONS AT SUBITER START 0
    VEC_CG_P,   //-- STEP p IN CG SUBITER 1
    VEC_CG_D,   //-- DIRECTION d IN CG SUBITER 2
    VEC_CG_HD,  //-- HESSIAN-VECTOR PRODUCT Hd 3 
    VEC_CG_R,   //-- RESIDUAL r IN CG SUBITER 4
    VEC_DIF1,   //-- FOR FINITE DIFFERENCING 5
    VEC_DIF2,   //-- FOR FINITE DIFFERENCING 6
    NUM_HFTN_ATOM_BASED_VECTORS  // 7
  };
