...
#ifndef LMP_MIN_SADDLE_LSRCH_H
#define LMP_MIN_SADDLE_LSRCH_H

#include "min_saddle.h"

namespace LAMMPS_NS {

class MinSaddleLineSearch : public MinSaddle {
 public:
  MinSaddleLineSearch(class LAMMPS *);
  ~MinSaddleLineSearch();
  void init();
  void setup_style();
  void reset_vectors();
 ...
 protected:
  ...
  typedef int (MinSaddleLineSearch::*FnPtr)(double, double &);
  FnPtr linemin;
