...
MinSaddleFire::MinSaddleFire(LAMMPS *lmp) : MinSaddle(lmp) {}

/* ---------------------------------------------------------------------- */

void MinSaddleFire::init()
{
  MinSaddle::init();
...
void MinSaddleFire::setup_style()
{
  double **v = atom->v;
...
void MinSaddleFire::reset_vectors()
{
  // atomic dof
...
int MinSaddleFire::iterate(int maxiter)
{
  bigint ntimestep;
